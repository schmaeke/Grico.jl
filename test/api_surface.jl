...
const EXPECTED_EXPORTED = Set(Symbol[:AbstractField, :AdaptivityLimits, :AdaptivityPlan,
                                     :AffineProblem, :AssemblyPlan, :AutoLinearSolver, :AxisDegrees,
                                     :BoundaryFace, :ByLeafDegrees, :CartesianGrid, :CellValues,
                                     :CGSolver, :DegreePlusQuadrature, :Dirichlet, :Domain,
                                     :EmbeddedSurface, :FGMRESSolver, :FaceValues, :FieldLayout,
                                     ...
                                     :InterfaceValues, :JacobiPreconditioner, :KernelScratch,
                                     :LOWER, :MeanValue, :NONE, :NonsymmetricOperator,
                                     :OperatorWorkspace, :PhysicalDomain, :PhysicalMeasure,
                                     :PointQuadrature, :ResidualProblem, :ResidualWorkspace, :SPD,
                                     :ScalarField, :SegmentMesh, :SpaceOptions, :State,
                                     ...
                                     :add_cell_bilinear!, :add_cell_linear!, :add_cell_quadrature!,
                                     :add_constraint!, :add_embedded_surface!, :add_interface!,
                                     :add_interface_bilinear!, :add_interface_linear!,
                                     :add_surface!, :add_surface_bilinear!, :add_surface_linear!,
                                     :add_surface_quadrature!, :apply, :apply!, :average, :avg,
                                     :block, :cell_apply!, :cell_center, :cell_degrees,
                                     :cell_diagonal!, :cell_lower, :cell_matrix!, :cell_residual!,
                                     :cell_rhs!, :cell_size, :cell_tangent_apply!, :cell_upper,
                                     :cell_volume, :coefficients, :compile, :component,
                                     :component_count, :constrain!, :derefine!, :extent,
                                     :face_apply!, :face_axis, :face_diagonal!, :face_matrix!,
                                     :face_residual!, :face_rhs!, :face_side, :face_tangent_apply!,
                                     :field_component_values, :field_count, :field_dof_count,
                                     :field_dof_range, :field_gradient, :field_layout, :field_name,
                                     :field_space, :field_values, :fields, :grad, :gradient, :grid,
                                     :inner, :interface_apply!, :interface_diagonal!,
                                     ...
                                     :normal, :normal_component, :normal_gradient, :operator_class,
                                     :origin, :plot_field, :plot_field!, :plot_mesh, :plot_mesh!,
                                     ...
                                     :tangent_apply!, :tensor_axis_gradients, :tensor_axis_values,
                                     :tensor_degrees, :tensor_gradient!, :tensor_interpolate!,
                                     :tensor_local_modes, :tensor_mode_count, :tensor_mode_shape,
                                     :tensor_point_count, :tensor_project!,
                                     :tensor_project_gradient!, :tensor_quadrature_shape,
                                     :tensor_values, :transfer_state, :transition, :value, :weight,
                                     :write_pvd, :write_vtk, :∇, :⋅])
...
const EXPECTED_QUALIFIED_PUBLIC = Set(Symbol[:AbstractBasisFamily, :AbstractDegreePolicy,
                                             ...
                                             :AbstractQuadrature, :AbstractQuadraturePolicy,
                                             :GaussLegendreRule, :Geometry, :GridSnapshot,
                                             :HCoarseningCandidate, :SampledMesh,
                                             :SampledMeshSkeleton, :SampledPostprocess,
                                             :SpaceTransition, :TensorQuadrature, :active_leaf,
                                             :adaptivity_plan, :axis_point_counts, :basis_family,
                                             :basis_mode_count, :basis_modes, :boundary_face_count,
