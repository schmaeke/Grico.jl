...
const EXPECTED_EXPORTED = Set(Symbol[:AbstractField, :AdaptivityLimits, :AdaptivityPlan,
                                     ...
                                     :add_cell!, :add_cell_quadrature!, :add_constraint!,
                                     :add_embedded_surface!, :add_interface!, :add_surface!,
                                     :add_surface_quadrature!, :apply, :apply!, :average, :block,
                                     :cell_apply!, :cell_center, :cell_degrees, :cell_diagonal!,
                                     :cell_lower, :cell_residual!, :cell_rhs!, :cell_size,
                                     :cell_tangent_apply!, :cell_upper, :cell_volume, :coefficients,
                                     :compile, :component_count, :constrain!, :derefine!, :extent,
                                     :face_apply!, :face_axis, :face_diagonal!, :face_residual!,
                                     ...
                                     :field_space, :field_values, :fields, :gradient, :grid,
                                     :interface_apply!, :interface_diagonal!, :interface_residual!,
                                     :interface_rhs!, :interface_tangent_apply!, :is_full_tensor,
                                     :jump, :l2_error, :local_dof_index, :local_mode_count, :minus,
                                     :mode_terms, :normal, :normal_component, :normal_gradient,
                                     ...
                                     :surface_diagonal!, :surface_residual!, :surface_rhs!,
                                     :surface_tangent_apply!, :tangent_apply, :tangent_apply!,
