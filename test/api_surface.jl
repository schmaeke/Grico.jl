...
const EXPECTED_EXPORTED = Set(Symbol[
  :AbstractField,
  :AdaptivityLimits,
  :AdaptivityPlan,
  :AffineProblem,
  ...
  :refine!,
  :relative_l2_error,
  :request_h_derefinement!,
  :request_h_refinement!,
  :request_p_derefinement!,
  :request_p_refinement!,
  :residual,
  :residual!,
  :rhs,
  :rhs!,
  ...
  :tensor_point_count,
  :tensor_project!,
  :tensor_project_gradient!,
  :tensor_quadrature_shape,
  :tensor_values,
  :transfer_state,
  :transition,
  :value,
...
const EXPECTED_QUALIFIED_PUBLIC = Set(Symbol[
  :AbstractBasisFamily,
  ...
  :boundary_face_count,
  :boundary_face_spec,
  :cell_quadrature_shape,
  :check_snapshot,
  :check_space,
  :check_topology,
  :coefficient_coarsening_indicators,
  :compact,
  :compact!,
  :continuity_kind,
  :continuity_policy,
  :coordinate,
  :covering_neighbor,
  :default_linear_solve,
  :default_tangent_linear_solve,
  :derived_adaptivity_plan,
  :dimension,
  :face_measure,
  :field_component_range,
  :finite_cell_quadrature,
  :first_child,
  :gauss_legendre_exact_degree,
  :gauss_legendre_rule,
  :global_cell_quadrature_shape,
  :h_adaptation_axes,
  ...
  :local_modes,
  :logical_coordinate,
  :map_from_biunit_cube,
  :map_to_biunit_cube,
  :minimum_gauss_legendre_points,
  :multiresolution_indicators,
  :neighbor,
  :opposite_active_leaves,
  :p_degree_change,
  :parent,
  :periodic_axes,
  :postprocess_supported,
  :projection_coarsening_indicators,
  :root_cell_count,
  :root_cell_counts,
  :root_cell_total,
...
@testset "API Surface" begin
  ...
  @test all(name -> Base.ispublic(Grico, name),
            union(EXPECTED_EXPORTED, EXPECTED_QUALIFIED_PUBLIC))
